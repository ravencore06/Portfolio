...
import FlipFadeText from './FlipFadeText.jsx';
...
function Hero() {
  ...
  const handleResume = () => {
    ...
    window.open(
      "https://drive.google.com/file/d/1SDqCU1Kj6_iPk-GiXqYYz7N09_kciLcl/view?usp=drive_link",
      "_blank",
      "noopener,noreferrer"
    );
  };
  ...
  const nameLetters = useMemo(() => "Srinidhi Sadhanala".split(""), []);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <FlipFadeText 
            words={["Srinidhi Sadhanala"]} 
            staggerDelay={0.08}
            textClassName={`text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight ${
